...
<motion.div variants={fadeIn('left',0.3)}  initial='hidden'whileInView={'show'} viewport={{once:false,amount:0.3}} className='flex flex-1 flex-col gap-y-12 mb-10 lg:mb-0'>
  ...
  <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
    ...
    {/* {pretitle} */}
    <div className='absolute -bottom-full left-12 group-hover:bottom-28 transition-all duration-500 z-50'><span className='text-gradient'>Airbnb Project</span></div>
    {/* {title} */}
    <div className='absolute -bottom-full left-12 group-hover:bottom-8 transition-all duration-700 z-50 font-bold'><span className='text-3xl text-white'>
  ...
  <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
    ...
    {/* {title} */}
    <div className='absolute -bottom-full left-12 group-hover:bottom-8 transition-all duration-700 z-50'><span className='text-3xl text-white font-bold'>i designed many web sites using figma during my studies</span></div>
  </div>
</motion.div>
<motion.div variants={fadeIn('left',0.5)}  initial='hidden'whileInView={'show'} viewport={{once:false,amount:0.3}} className='flex-1 flex flex-col gap-y-10'>
  ...
  <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
    ...
    {/* {title} */}
    <div className='absolute -bottom-full left-12 group-hover:bottom-8 transition-all duration-700 z-50'><span className='text-3xl text-white font-bold'>Small projects Like To do List for tasks</span></div>
  </div>
  {/* {image} */}
  <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
    {/* {overlay} */}
    ...
    {/* {title} */}
    <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all duration-700 z-50'><span className='text-3xl text-white font-bold'>i created some portfolios and i sold them</span></div>
  </div>
  <div className='group relative overflow-hidden border-2 border-white/50 rounded-xl'>
    {/* {overlay} */}
    <div className='group-hover:bg-black/70 w-full h-full absolute z-40 transition-all duration-300'></div>
    {/* {img} */}
    <img src={commerce} alt=""  className='group-hover:scale-125 transition-all duration-500'/>
    {/* {pretitle} */}
    <div className='absolute -bottom-full left-12 group-hover:bottom-44 transition-all duration-500 z-50 font-bold font-bold '><span className='text-gradient'>
      web site e-commerce
      </span></div>
    {/* {title} */}
    <div className='absolute -bottom-full left-12 group-hover:bottom-14 transition-all font-bold duration-700 z-50'><span className='text-2xl text-white'>i created whole e-commerce web-site using NExt jsfor front-end and strapi stripe for back-end</span></div>
  </div>
